...
Timezone is now a searchable IANA timezone setting. Leave it blank to follow the display timezone. Existing installations retain their previous effective timezone through the reviewed Cloud migration. New local setups use UTC instead of the invalid America/Dallas fallback; ambiguous existing settings stay pinned for review.
